...
function Nightmare(options) {
  ...
  this.queue((done) => {
    ...
    this.child.on('open-url', function () { log('open-url', JSON.stringify(Array.prototype.slice.call(arguments))); });
    ...
    this.child.on('did-start-loading', function (e) { e.preventDefault();log('did-start-loading', JSON.stringify(Array.prototype.slice.call(arguments))); });
